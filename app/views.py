...
app.config[' INITIAL_FILE_UPLOADS'] = 'C:\Users\16025\Desktop\Image_watermarking_app\app\static\uploads'
    ...
    if request.method == "POST":
       ...
       # Printing lowercase
        ...
        if option == 'logo watermark':
            ...
            timg = Image.fromarray(image_logow)  
